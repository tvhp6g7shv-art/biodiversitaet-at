...
const VERSION = {
  nummer:     "13",                   // 11 Belastungen (Querbauwerke), 12 Herkunft des Schutzes, 13 Strenge des Schutzes
  datum:      "2026-09-07",           // maschinenlesbar, für <time datetime>
  datum_text: "7. September 2026",    // sichtbar
  ...
  function baueAlles() {
    ...
    */
    ...
    /* Schließt den Bereich Landwirtschaft ab: Die beiden Abschnitte darüber
       ...
       Bio-Anteil auf schrumpfender Grünlandfläche liest sich sonst größer,
       als er ist. */
    sicher("Grünland",       () => BIO.baueGruenland(geladen.gruenland));
